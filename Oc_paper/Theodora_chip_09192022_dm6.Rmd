...
venn.diagram(
        ...
        filename = paste(data_path, "venn_diagram_early.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        filename = paste(data_path, "venn_diagram_late.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        filename = paste(data_path, "venn_diagram_early_opa_oc_only.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        category.names = c("Opa" , "Oc"),
        filename = paste(data_path, "venn_diagram_late_opa_oc_only.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        category.names = c("Opa" , "Zld " , "Bcd", "Oc"),
        filename = paste(data_path, "venn_diagram_early_promoters.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        category.names = c("Opa" , "Zld " , "Oc"),
        filename = paste(data_path, "venn_diagram_late_promoters.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        category.names = c("Opa" , "Zld " , "Bcd", "Oc"),
        filename = paste(data_path, "venn_diagram_early_non-promoters.png", sep=""),
        output=TRUE,
...
venn.diagram(
        ...
        category.names = c("Opa" , "Zld " , "Oc"),
        filename = paste(data_path, "venn_diagram_late_non-promoters.png", sep=""),
        output=TRUE,
...
rnaseq_up<-rnaseq[rnaseq$log2.fold_change.>0 & rnaseq$significant=="yes", 1]
rnaseq_dn<-rnaseq[rnaseq$log2.fold_change.<0 & rnaseq$significant=="yes", 1]

data_path="/home/fgao/Data_CHIP/Stathopoulos_Lab/Theodora_09192022/dm6_epigenome/"
genes_oc_late<-data.frame(read.table(paste(data_path, "CHIP_oc_late_homer_promoter_genes.txt", sep=""), header=T, sep="\t"))[,1]
genes_opa_late<-data.frame(read.table(paste(data_path, "CHIP_opa_late_homer_promoter_genes.txt", sep=""), header=T, sep="\t"))[,1]
genes_zld_late<-data.frame(read.table(paste(data_path, "CHIP_zld_late_homer_promoter_genes.txt", sep=""), header=T, sep="\t"))[,1]
genes_overlap_oc_only_late<-data.frame(read.table(paste(data_path, "overlap_oc_only_late_homer_promoter_genes.txt", sep=""), header=T, sep="\t"))[,1]
genes_overlap_opa_oc_late<-data.frame(read.table(paste(data_path, "overlap_opa_oc_late_homer_promoter_genes.txt", sep=""), header=T, sep="\t"))[,1]
genes_overlap_opa_only_late<-data.frame(read.table(paste(data_path, "overlap_opa_only_late_homer_promoter_genes.txt", sep=""), header=T, sep="\t"))[,1]
...
for (deg in list("rnaseq_up", "rnaseq_dn"))
{
...
#  for (chip in list("genes_overlap_oc_only_late", "genes_overlap_opa_oc_late", "genes_overlap_opa_only_late"))
  {
    p_value<-c(p_value, unlist(calc_overlap(get(deg), get(chip), nrow(rnaseq))[1]))
    count_value<-c(count_value, unlist(calc_overlap(get(deg), get(chip), nrow(rnaseq))[2]))
    gene_overlap<-c(gene_overlap, paste(unlist(calc_overlap(get(deg), get(chip), nrow(rnaseq))[3]), sep=","))
    deg_id<-c(deg_id, deg)
...
library(ggplot2)
plot_pvalue<-ggplot(p_table, aes(x=deg_id, y=chip_id, fill=count_value)) + geom_tile() + ggtitle("overlapping gene counts") + theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=0.5), text = element_text(size = 16), axis.text = element_text(size = 16))     
plot_pvalue
png(paste(data_path, "rnaseq_chipseq_overlap_gene_counts.png", sep=""), width=640, height=640)
plot_pvalue
dev.off()

ggsave(file=paste(data_path, "rnaseq_chipseq_overlap_gene_counts.svg", sep=""), plot=plot_pvalue, width=8, height=8)
